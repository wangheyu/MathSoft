...
\begin{itemize}
  ...
  \item 课程组织形式（每周）：2小时课堂讲授
  \item 为数学院同学定制（企图替代人工智能基础课），非专业同学慎选！
\end{itemize}
\begin{block}{考核方式}
\begin{itemize}
  \item \textbf{无期末考试}
...
\begin{frame}{准备好你的 AI 工具}
    \begin{itemize}
        \item 免费工具：deepseek, kimi，qianwen，AI 校园(chat.zju.edu.cn)
        \item 收费工具：askmanyai.cn
        \item 注意事项：仔细看一下用户协定（换个AI看），明确知识权归属。不要上传涉密材料。
        \item 暂时掌握网页端使用就可以。
    \end{itemize}
...
\begin{itemize}
    ...
    \item 介绍 overleaf，但本地 latex 不可少 (overleaf.zju)
    \item 需要一个编译器，推荐 vs code，装在主机而不是虚拟机中
    \item 代码托管：zju.git，课程网站
\end{itemize}
\end{frame}

\begin{frame}{用 AI 学习数学}
  \begin{itemize}
    \item 校准上下文环境，上传电子资料
    \item 翻译、解释、讨论、举例、反驳
    \item 复习规划
